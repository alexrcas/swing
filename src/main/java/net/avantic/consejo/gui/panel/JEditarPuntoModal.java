 ...
 * @author alexr
 */
public class JEditarPuntoModal extends javax.swing.JPanel {

    /**
     * Creates new form JCrearPuntoModal
     */
    public JEditarPuntoModal(Punto punto) {
        initComponents();
        this.nombreTextField.setText(punto.getNombre());
        this.descripcionTextField.setText(punto.getDescripcion());
    }
