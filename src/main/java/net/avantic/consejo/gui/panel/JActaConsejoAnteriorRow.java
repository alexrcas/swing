 ...
 * @author alexr
 */
public class JActaConsejoAnteriorRow extends javax.swing.JPanel {

    /**
     * Creates new form JDocumentoRow
     */
    
    private ActaConsejoAnterior actaConsejoAnterior;
    
    private JActaConsejoAnterior parent;
    
    public JActaConsejoAnteriorRow() {
        initComponents();
    }
    
    public JActaConsejoAnteriorRow(JActaConsejoAnterior parent, ActaConsejoAnterior actaConsejoAnterior) {
        initComponents();
        ...
        this.actaConsejoAnterior = actaConsejoAnterior;
        this.jLabel1.setText(actaConsejoAnterior.getNombre());
        this.jLabel2.setText(actaConsejoAnterior.getRuta());
        
        File fileWorkingCopy = new File(actaConsejoAnterior.getRutaWorkingCopy());
    ...
    private void eliminarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarButtonActionPerformed
        ...
        if (seleccion == 0) {
            this.parent.eliminarPortada(this.actaConsejoAnterior);
        }
    ...
    private void verDocumentoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verDocumentoButtonActionPerformed
        if (Desktop.isDesktopSupported()) {
            try {
                Desktop.getDesktop().open(new File(this.actaConsejoAnterior.getRutaWorkingCopy()));
