 ...
 * @author alexr
 */
public class JDocumentoRow extends javax.swing.JPanel {
    ...
    private JPunto parent;
    
    public JDocumentoRow() {
        initComponents();
    }
    
    public JDocumentoRow(JPunto parent, Documento documento) {
        initComponents();
        ...
        this.jLabel1.setText(documento.getNombre());
        this.jLabel2.setText(documento.getRuta());
    ...
    private void eliminarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarButtonActionPerformed
        int seleccion = JOptionPane.showConfirmDialog(this, "¿Desea eliminar el documento asociado a este punto?", "Eliminar Documento", JOptionPane.YES_NO_OPTION);
        if (seleccion == 0) {
            this.parent.eliminarDocumento(this.documento);
        }
    ...
    private void bajarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bajarButtonActionPerformed
        ...
        this.parent.reordenarBajarDocumento(documento);
    ...
    private void subirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subirButtonActionPerformed
        ...
        this.parent.reordenarSubirDocumento(documento);
    ...
    private void verDocumentoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verDocumentoButtonActionPerformed
        if (Desktop.isDesktopSupported()) {
            try {
                Desktop.getDesktop().open(new File(this.documento.getRutaWorkingCopy()));
