 ...
 * @author alexr
 */
public class JPortadaRow extends javax.swing.JPanel {
    ...
    private JPortada parent;
    
    public JPortadaRow() {
        initComponents();
    }
    
    public JPortadaRow(JPortada parent, Portada portada) {
        initComponents();
        ...
        this.jLabel1.setText(portada.getNombre());
        this.jLabel2.setText(portada.getRuta());
        
        File fileWorkingCopy = new File(portada.getRutaWorkingCopy());
    ...
    private void eliminarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarButtonActionPerformed
        int seleccion = JOptionPane.showConfirmDialog(this, "¿Desea eliminar la portada?", "Eliminar Portada", JOptionPane.YES_NO_OPTION);
        if (seleccion == 0) {
            this.parent.eliminarPortada(this.portada);
        }
    ...
    private void verDocumentoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verDocumentoButtonActionPerformed
        if (Desktop.isDesktopSupported()) {
            try {
                Desktop.getDesktop().open(new File(this.portada.getRutaWorkingCopy()));
